...
const AddDog = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Then create dog with image URL
      ...
      <div id="user-dogs" className="flex flex-col gap-4">
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <button className="btn btn-outline btn-md">Registrar nuevo</button>
            <div className="h-80 overflow-y-scroll">
              {user.dogs.map((dog) => (
                <div
                  key={dog.id}
                  className="card card-bordered flex flex-row shadow-md mx-2 p-5 items-center justify-evenly gap-4"
                >
                  <img
                    src={dog.pfp}
                    alt={dog.name}
                  ...
                  <button className="btn btn-square btn-secondary btn-md btn-ghost">
                    <FaEdit />
                  </button>
                </div>
              ))}
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="form-control">
                <label className="cursor-pointer label">
                  <span className="label-text">¿Tiene las vacunas al día?</span>
                  <input
                    type="checkbox"
                    name="vaccinated"
                    className="checkbox checkbox-secondary"
